        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-8 px-6">
            ...
            <div class="md:col-span-2 space-y-8">
                ...
                <section>
                    ...
                    <ul class="divide-y border rounded-lg bg-white">
                        <li v-for="lesson in course.lessons" :key="lesson.id" class="p-3 flex items-center justify-between">
            ...
            <div class="space-y-6">
                <div class="bg-white border rounded-lg shadow p-6 sticky top-6">
                    <img :src="course.image_path" alt="Course image" class="w-full h-40 object-cover rounded mb-4" />
