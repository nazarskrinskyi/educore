...
const submit = () => {
    form.post(route('instructor.login'), {
...
<template>
    <GuestLayout>
        ...
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Instructor Login</h2>
            <p class="mt-2 text-sm text-gray-600">Sign in to manage your courses</p>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 text-center">
                ...
                >
                    Don't have an account? <span class="underline">Register as Instructor</span>
                </Link>
            </div>
        </form>
    </GuestLayout>
