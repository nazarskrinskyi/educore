...
<template>
    <GuestLayout>
        <Head title="Instructor Registration" />

        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Instructor Registration</h2>
            <p class="mt-2 text-sm text-gray-600">Create your instructor account to start teaching</p>
        </div>
        ...
        <form @submit.prevent="submit" class="w-auto">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <a
                    :href="route('auth.google.redirect', { role: 'instructor' })"
